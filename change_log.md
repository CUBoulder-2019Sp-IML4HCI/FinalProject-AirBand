...
#### Week 15
I worked on finalizing the gloves and securely fastening all of the components, which involved refamiliarizing myself with sewing. I helped Mikhaila with finishing up the web app, troubleshooting the webcam inputs, and allowing users to operate the program with the gloves on. I helped finish up the writeup and worked with Jack to create a video.
